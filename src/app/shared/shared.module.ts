...
@NgModule({
  declarations: [AddToCartComponent, VideoPopupComponent, ContactEmailComponent,CancelOrderComponent, PopupFormComponent],
  imports: [
    TranslateModule.forRoot(),
    CommonModule,
    FormsModule
  ],
  exports:[AddToCartComponent, CancelOrderComponent]
})
